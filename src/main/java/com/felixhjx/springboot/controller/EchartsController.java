...
public class EchartsController {
    ...
    @GetMapping("/example/line")
    public Result getLine(){
        Map<String,Object> mapLine=new HashMap<>();
        mapLine.put("x", CollUtil.newArrayList("Mon", "Tue", "Wed", "Thu", "Fri", "Sat","Sun"));
        mapLine.put("y",CollUtil.newArrayList(150, 230, 224, 218, 135, 147, 260));
        return Result.success(mapLine);
    }
